...
Este proyecto ofrece una **API RESTful basada en FastAPI** que permite a los usuarios:
...
El objetivo es servir como **backend de un sistema SaaS** especializado en visión por computadora, donde la lógica de procesamiento de la imagen es la funcion principal.
